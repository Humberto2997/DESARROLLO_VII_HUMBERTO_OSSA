...
echo "</br>Estudiante con el promedio más alto: {$mejorEstudiante['nombre']} ({$mejorEstudiante['promedio']})\n";
...
$estudiantesTutoria = estudiantesQueNecesitanTutoria($estudiantes);
echo "</br>Estudiantes que necesitan tutoría (promedio menor a 75):\n";
...
echo "</br>Estudiantes de honor (promedio de 90 o más):\n";
