...
function contarCiudadesPorInicial($arr, $letra) {
  ...
  foreach ($arr as $ciudad) {
      if (stripos($ciudad, $letra) === 0) {  // Comprobamos si la ciudad empieza con la letra
          $contador++;
      }
  }
  return $contador;
...
echo "</br>Número de ciudades que comienzan con la letra 'S': " . contarCiudadesPorInicial($ciudades, 'S') . "\n";
