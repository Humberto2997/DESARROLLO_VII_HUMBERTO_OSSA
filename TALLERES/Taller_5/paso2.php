...
// Tu código aquí
// Función para encontrar el producto con mayor valor total en inventario
...
// Mostrar el producto con mayor valor total
$resultado = productoMayorValor($inventario);
echo "\nProducto con mayor valor total: {$resultado['producto']} ($" . $resultado['valor'] . ")\n";
?>