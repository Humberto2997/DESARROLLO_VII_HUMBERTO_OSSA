...
// Imprimir estudiantes que necesitan tutoría
echo "\nEstudiantes que necesitan tutoría (promedio < 75):\n";
$tutoria = estudiantesNecesitanTutoria($estudiantes);
if (empty($tutoria)) {
    echo "Ninguno\n";
} else {
    foreach ($tutoria as $nombre) {
        echo "- $nombre\n";
    }
}

// Imprimir estudiantes de honor
echo "\nEstudiantes de honor (promedio >= 90):\n";
$honor = estudiantesDeHonor($estudiantes);
if (empty($honor)) {
    echo "Ninguno\n";
} else {
    foreach ($honor as $nombre) {
        echo "- $nombre\n";
    }
}
