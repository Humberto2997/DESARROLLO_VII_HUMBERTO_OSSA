...
$misComidas = ["Hamburguesa", "Salchipapa", "Pollo en salsa alfredo"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Picadas", "Arooz con carne", "Coditos"]; // Reemplaza con las comidas favoritas de tu amigo
