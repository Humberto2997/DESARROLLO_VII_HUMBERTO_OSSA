...
$misComidas = ["Salchipapa", "Hamburguesa", "Tacos"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Pizza", "Sushi", "Sopa"]; // Reemplaza con las comidas favoritas de tu amigo
