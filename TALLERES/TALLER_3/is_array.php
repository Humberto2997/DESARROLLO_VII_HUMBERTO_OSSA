...
$miArray = ["Humberto","Jose","Ossa","Aranda",]; // Reemplaza esto con tu propio array
$miString = "Humberto"; // Reemplaza esto con tu propio string
$miNumero = 29; // Reemplaza esto con tu propio número
