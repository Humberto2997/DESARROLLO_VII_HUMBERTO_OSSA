...
$misAmigos = ["Carlos", "Jonathan","Jorge"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Daniel", "Joel"); // Reemplaza las comillas vacías con los nombres de tus amigos
