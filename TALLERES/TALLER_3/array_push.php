...
$misAmigos = ["Jipo", "Calito", "Jorge"]; // Reemplaza esto con tu array de amigos
echo "<br>Array original de amigos:";
print_r($misAmigos);

array_push($misAmigos, "Richard", "Sergio"); // Reemplaza las comillas vacías con los nombres de tus amigos
